...
import com.zzy.acl.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public List<JSONObject> getMenu(String username) {
        ...
        //根据用户id获取用户菜单权限
        List<JSONObject> permissionList = permissionService.selectPermissionvalueByUserId(user.getId());
