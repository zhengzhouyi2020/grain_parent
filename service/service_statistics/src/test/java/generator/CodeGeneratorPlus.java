...
public class CodeGeneratorPlus {
    ...
    public void run(){
        ...
        gc.setOutputDir("J:/javaProgram/grain_parent/service/service_order"+ "/src/main/java");
        gc.setAuthor("zzy");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/grain_order?serverTimezone=GMT%2B8&useUnicode=true&useSSL=false&characterEncoding=utf8");
